...
# Jenkins short-cuts
alias jenkins.port-change.58080='sed "s/--httpPort=[\d]+/--httpPort=58080/g" $(brew --prefix jenkins)/homebrew.mxcl.jenkins.plist > $(brew --prefix jenkins)/homebrew.mxcl.jenkins.plist'
